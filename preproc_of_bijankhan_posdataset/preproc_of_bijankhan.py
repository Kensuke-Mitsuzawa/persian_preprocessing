...
import sys, subprocess, codecs, commands;
...
def main():
        ...
        if len(sys.argv)!=3:
                ...
                write_out.close();
                #result_of_preper2.rb=subprocess.Popen(['ruby1.9', '../lib/pre_per2.rb', './tmp_out_01', sys.argv[2] ],);
                commands.getoutput('ruby1.9 ../lib/pre_per2.rb {0}>{1}'.format(out_of_dummy,out_of_preper));
